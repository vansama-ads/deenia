...
@section('page-title', 'Tambah Lesson')

@section('title', 'Admin - Tambah Lesson')

@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Tambah Lesson Baru</h2>
        </div>
        ...
        <div class="admin-card-body">
            ...
            <form action="{{ route('admin.lessons.store') }}" method="POST" class="admin-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror"
                        placeholder="Contoh: Pengenalan Python" value="{{ old('title') }}" required>
                    @error('title')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" class="form-control @error('content') is-invalid @enderror"
                        placeholder="Masukkan konten lesson..." rows="10">{{ old('content') }}</textarea>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">Simpan Lesson</button>
